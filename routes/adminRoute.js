...
import upload from '../middleware/imageUploading.js';
...
import {  getAdminDashboard,getAdminPdct, blockUser,unblockUser, getAdminAddPdct,
          ...
          editPostAdminCategory,editgetAdminCategory, editAdminPdct, editgetAdminPdct, editPostAdminPdct, blockProduct, unblockProduct, getAdminLogout, getAdminForgotPassword} from "../controllers/adminController.js";
...
//admin-forgot-passwprd
adminRouter.get('/forgot-password',getAdminForgotPassword);
